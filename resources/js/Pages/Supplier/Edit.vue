                            ...
                            <div>
                                ...
                                <div class="grid gap-4 md:grid-cols-2 sm:gap-6 mb-5">
                                    <div class="">
                                        ...
                                        />
                                        <InputError class="mt-1" :message="form.errors.account_holder" />
                                    </div>
                                    <div class="">
                                        <InputLabel
                                            for="account_number"
...
const url = 'suppliers'
const pageTitle = 'Update Supplier'
...
const form = useForm({
    ...
    shop_name: props.model.shop_name,
    bank_name: props.model.bank_name,
    account_holder: props.model.account_holder,
